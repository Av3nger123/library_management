...
@router.get("")
async def get_audits(book_item_id:int=None,status:str=None,book_id:int=None,user_id:int=None,audit_service:AuditService = Depends(get_audit_service)):
    return await audit_service.get_audits(book_id,user_id,book_item_id,status)